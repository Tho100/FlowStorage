    ...
    public partial class gifFORM : Form {
        ...
        public gifFORM(String _titleName) {
            ...
            try {
                ...
                command.Parameters.AddWithValue("@filepath",label1.Text);
        ...
        private void guna2Button4_Click(object sender, EventArgs e) {
            try {
                ...
                String _readGifFiles = "SELECT CUST_FILE FROM file_info_gif WHERE CUST_USERNAME = @username AND CUST_FILE_PATH = @filetitle";
